    ...
    <section class="ev-hero" aria-label="Vetrina principale">
        <div class="ev-hero__image-wrap">
            ...
            <div class="ev-hero__content">
                ...
                <h1>Scopri prodotti unici per il tuo stile quotidiano</h1>
                <p>Una home moderna, intuitiva e pensata per accompagnare l'utente dall'ispirazione all'acquisto in pochi click.</p>
